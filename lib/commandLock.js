 ...
 *
 * Sync liveness is read from `.siteglide/user/sync/<pid>.json`.
 * Pull/deploy claim files under `.siteglide/user/command-locks/<pid>.json`.
 */
...
const LOCK_DIR_SEGMENTS = userSegments('command-locks');
...
const SIDE_EFFECT_HELPER =
	...
	'including infinite update loops.';
