 ...
 *
 * Sync liveness is read from `.siteglide/IDE/sync/<pid>.json`.
 * Pull/deploy claim files under `.siteglide/IDE/command-locks/<pid>.json`.
 */
...
const LOCK_DIR_SEGMENTS = ideSegments('command-locks');
