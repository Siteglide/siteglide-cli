/**
 * Per-developer `.siteglide/IDE/ai-agent-preferences.json` — `pull_behaviour.include` /
 * `exclude` choose which IDE roots pull may create skill folders in. Local to the
 * current machine, unlike the shared module settings in `.siteglide/cli-settings/`.
 */
const fs = require('fs-extra');
const path = require('path');
const logger = require('./logger');

const AI_AGENT_PREFERENCES_DIR = path.join('.siteglide', 'IDE');
