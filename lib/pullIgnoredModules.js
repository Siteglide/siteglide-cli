...
const defaultPullBehaviour = () => {
	return {
		usage: [
			...
			'',
			'AI skills: only module_984 distributes skills (SKILL.md files). When pulled, its public/assets/agents/ tree merges into ./.agents at the project root — nothing is written under ./modules/module_984/. Exclude module_984 if you do not want skills locally.',
			'',
			'Examples:',
			'  "include": ["module_357"],',
