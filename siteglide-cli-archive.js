...
const makeArchive = (path, directory, withAssets) => {
	...
	if (withAssets!==true) options.ignore = ['assets/**/*(*.gif|*.jpeg|*.jpg|*.png|*.svg|*.mp4|*.mov)'];
...
makeArchive(program.target, dir.LEGACY_APP, program.withAssets);
